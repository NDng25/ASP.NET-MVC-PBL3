...
namespace FreeCy.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //ViewBag.Categories = new CategoryDAO().ListAllCategoty();
            ViewBag.RelatedProducts = new ProductDAO().ListFeatureProduct(4, user);
            //int totalRecord = productDao.GetTotalRecords();
        ...
        public ActionResult ListProductByCategory(int cateId, int page = 1, int pageSize = 1)
        {
            ...
            int totalRecord = 0;
            var model = new ProductDAO().ListByCategoryId(user,cateId, ref totalRecord, page, pageSize);
